...
import com.censoMain.customControlls.CustomDataGridStyle.DataContainer;
import com.censoMain.customControlls.CustomDataGridStyle.HeaderCell;
import com.censoMain.customControlls.CustomDataGridStyle.HeaderContainer;
import com.censoMain.customControlls.CustomDataGridStyle.HeaderSpliterCell;
...
public class CustomDatagrid extends LinearLayout{

	private Context mContext;
	private LinearLayout mListHeader;
	private CustomHorizontalScroller mHsv;
	...
	class MemberCollection{
		...
		public CustomDatagrid DATAGRID_WINDOW;
		...
		public CustomDataTable DATA_SOURCE;
	}
	
	public CustomDatagrid(Context context , AttributeSet attrs) throws Exception {
        
		super(context, attrs);
		setOrientation(HORIZONTAL);
	    setBackgroundColor(CustomDataGridStyle.DataGrid.BackgroundColor);
	...
	private void initHeader()
	{
		...
		for(int i = 0; i < mc.COLUMN_STYLE.size(); i++)
		{
			...
			HeaderView = new CustomHeader(getContext(), mc);
	...
	public void create()
	{
		...
		mListHeader.setBackgroundDrawable(getResources().getDrawable(HeaderContainer.Background));
		...
		mTvNoData.setText(strNoDataText == null ? "Sin datos" : strNoDataText);
		mTvNoData.setGravity(Gravity.LEFT);
		mTvNoData.setTextColor(CustomDataGridStyle.DataCell.ForegroundColor);
		...
		mHsv = new CustomHorizontalScroller(mContext, mc);
	...
	public void setDataSource(CustomDataTable data)
	{
		mc.DATA_SOURCE = data;
	}
	
	public CustomDataTable getDataSource()
	{
